...
1. pick a random leetcode question not in the astro-leet repo yet, or one blog post where not all 4 language solutions are done yet.
...
1. implement the solutions in python, unit tests covering edge cases
...
1. use 3 subagents to work in parallel to implement the solutions and unit tests in the other three programming languages
